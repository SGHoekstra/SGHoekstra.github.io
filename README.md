...
4. **Work in progress.** Both entries use descriptive working titles, not the real ones. Replace them with the titles from the manuscripts, and confirm the author lines.
